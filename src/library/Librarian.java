...
/**
 * Represents a librarian responsible for managing customers, loans, and interacting with the BNF API.
 */
public class Librarian {
	...
	/**
	 * The file path to the library data JSON file.
	 */
	...
	/**
	 * This method calls the BNF API to search a list of books according to filters.
	 *
	 ...
	 * @throws BookNotInDataBaseException If the search results are empty
	 */
